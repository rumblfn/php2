    ...
    switch ($strategy) {
        ...
        case 'html_attr':
            ...
            $string = preg_replace_callback('#[^a-zA-Z0-9,\.\-_]#Su', function ($matches) {
                 ...
                 * hex entities for the Unicode replacement character.
                 */
                ...
                /*
                 * Check if the current character to escape has a name entities we should
                ...
                if (1 === \strlen($chr)) {
                     ...
                     *     XML Parsing Error: undefined entities
                     */
                    static $entityMap = [
                        34 => '&quot;', /* quotation mark */
                        38 => '&amp;',  /* ampersand */
                 ...
                 * characters where a named entities does not exist.
                 */
