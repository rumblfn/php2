...
CREATE TABLE `basket` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_item_id_basket` (`item_id`),
  KEY `fk_user_id_basket` (`user_id`),
  CONSTRAINT `fk_item_id_basket` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`),
  CONSTRAINT `fk_user_id_basket` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
INSERT INTO `basket` VALUES (1,13,2),(7,14,2),(8,14,5),(10,13,1),(12,13,3),(13,13,7),(14,13,8);
...
-- Dump completed on 2022-04-25 22:08:31
